...
- `data_sources` (name, connection_type, schedule)
- `data_warehouse_platform`
- `data_warehouse_schemas`
- `data_retention_days`
- `data_reconciliation_tolerance_bps`
...
- Reconciliation variance exceeds `data_reconciliation_tolerance_bps`
