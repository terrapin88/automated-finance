                    ...
                    - - Executing wires without proper approval hierarchy
                      - - Modifying custody or banking agreements without CFO approval
                        - - Over-riding custody provider reconciliation disputes without evidence
                          ...
                          - - custody_and_banking.banks
                            - - custody_and_banking.custodians
                              - - custody_and_banking.exchanges
                                - - custody_and_banking.wallets
                                  - - custody_and_banking.dual_control_required
                                    - - service_providers.prime_broker
                                      - - risk_and_controls.approval_matrix.wire_threshold_usd
                                        - - risk_and_controls.approval_matrix.new_beneficiary_requires_call_back
                                          - - risk_and_controls.approval_matrix.exchange_whitelist_required
                                                                                                                                            ...
                                                                                                                                            - - Daily reconciliation clears by EOD or flagged with owner
                                                                                                                                              - - No unmatched custody items >7 days old without escalation
                                                                                                                                                - - Dual control (if required) evident in approval logs
                                                                                                                                                  ...
                                                                                                                                                  - ## Control posture
                                                                                                                                                  - - Approvals:
                                                                                                                                                    -   - Wires >threshold: Follow risk_and_controls.approval_matrix.wire_threshold_usd
                                                                                                                                                        -   - New beneficiary: Requires call-back if risk_and_controls.approval_matrix.new_beneficiary_requires_call_back
                                                                                                                                                            -   - Exchange additions: Whitelist required if risk_and_controls.approval_matrix.exchange_whitelist_required
                                                                                                                                                                - - Dual control:
                                                                                                                                                                  -   - Enforced if custody_and_banking.dual_control_required
                                                                                                                                                                      - - Audit trail:
                                                                                                                                                                                ...
                                                                                                                                                                                -   - Custody reconciliation differences documented
                                                                                                                                                                                    - - Record retention:
                                                                                                                                                                                      -   - Follow risk_and_controls.record_retention_years
                                                                                                                                                                                          ...
                                                                                                                                                                                          - ## Escalation triggers
                                                                                                                                                                                          - - Any wire >wire_threshold_usd without proper approval
                                                                                                                                                                                                  ...
                                                                                                                                                                                                  - - Custodian fee discrepancy >materiality
                                                                                                                                                                                                    - - Cold storage / wallet balance missing confirmation
                                                                                                                                                                                                      - - Prime broker margin call or haircut change
                                                                                                                                                                                                        ...
                                                                                                                                                                                                        - ## Tooling hooks
                                                                                                                                                                                                        - - Systems:
                                                                                                                                                                                                          -   - GL: systems.general_ledger (cash accounts)
                                                                                                                                                                                                              -   - Custodian platforms: custody_and_banking.custodians (e.g., Fidelity, BNY, etc.)
                                                                                                                                                                                                                  -   - Banks: custody_and_banking.banks
                                                                                                                                                                                                                      -   - Exchanges: custody_and_banking.exchanges
                                                                                                                                                                                                                          - - Files / folders:
                                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                                      -   - <YYYY-MM-DD>_<ENTITY>_wire_request_<ID>.pdf
                                                                                                                                                                                                                                                          -   - <YYYY-MM-DD>_<BENEFICIARY>_kyc_aml.pdf
                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                              - 1) **Daily Custody Reconciliation**
                                                                                                                                                                                                                                                                2)    - Compare GL cash vs. custodian statements; document differences.
                                                                                                                                                                                                                                                                      - 2) **Wire Request Intake & Approval Routing**
                                                                                                                                                                                                                                                                        3)    - Validate beneficiary, check threshold, route for approval, execute on clearance.
                                                                                                                                                                                                                                                                              - 3) **Beneficiary On-Boarding**
                                                                                                                                                                                                                                                                                4)    - Collect KYC/AML docs, verify approval, create in systems, confirm with legal/compliance.
                                                                                                                                                                                                                                                                                      - 4) **Exchange Whitelist Review**
                                                                                                                                                                                                                                                                                        5)    - Evaluate new exchange, verify compliance with whitelist policy, escalate if needed.
