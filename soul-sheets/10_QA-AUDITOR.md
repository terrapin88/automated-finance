            ...
            - - Determining pass/fail of controls; recommend escalation to compliance
              - - Validating management's financial statement representations (escalate to CFO/audit committee)
                - - Changing GL entries or transaction records based on testing findings (escalate for correction)
                  ...
                  - ```yaml
                    organization.audit.annual_audit_required  # boolean
                    organization.audit.external_auditor_name
                    organization.audit.fiscal_year_end
                    organization.audit.materiality_threshold_basis_points
                    organization.audit.key_account_list[]  # NAV, fees, distributions, etc.
                    organization.accounting.fund_general_ledger_system
                    organization.accounting.custody_reconciliation_frequency  # daily, monthly, quarterly
                    ```
