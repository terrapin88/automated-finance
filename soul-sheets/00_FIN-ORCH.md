...
- `entities_total_count`, `entities_types.*`
- `service_providers_*` (auditor, tax_firm, legal, etc.)
- `custody_*` (banks, custodians, wallets, dual_control_required)
- `systems_*` (general_ledger, portfolio_accounting, data_warehouse, etc.)
- `close_*` (cadence, deadline_days, nav_estimated)
- `valuation_*`, `controls_*`, `team_*`
