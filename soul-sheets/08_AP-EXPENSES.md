              ...
              - - Approving payment exceptions or vendor setup changes (escalate to CFO)
                - - Processing expense reimbursements from fund employees or investors (treat as employee/investor expense, not fund expense)
                  ...
                  - ```yaml
                    ...
                    organization.fund_structures[].expense_allocation_formula  # headcount, AUM, direct, tiered
                    organization.payment_rails.ach_enabled
                    organization.payment_rails.wire_enabled
                    organization.payment_rails.approved_banks[]
                    organization.accounting.expense_categories[]  # admin, audit, legal, operations, etc.
                    organization.accounting.default_expense_account  # GL account for AP
                    organization.accounting.expense_allocation_method  # fixed vs variable
                    ```
